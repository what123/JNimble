...
public final class AuditDisplayNames {
    ...
    private static final Map<String, String> ACTION_DISPLAY;
    private static final Map<String, String> TARGET_TYPE_DISPLAY;
    private static final Map<String, String> OUTCOME_DISPLAY;

    static {
        Map<String, String> actions = new LinkedHashMap<>();
        actions.put(AuditActions.PLUGIN_DESCRIPTOR_INSTALL, "安装插件");
        actions.put(AuditActions.PLUGIN_JAR_INSTALL, "安装插件");
        actions.put(AuditActions.PLUGIN_JAR_REPLACE, "替换插件包");
        actions.put(AuditActions.PLUGIN_ENABLE, "启用插件");
        actions.put(AuditActions.PLUGIN_DISABLE, "禁用插件");
        actions.put(AuditActions.PLUGIN_UNINSTALL, "卸载插件");
        actions.put(AuditActions.PLUGIN_RELOAD, "重载插件");
        actions.put(AuditActions.USER_CREATE, "创建用户");
        actions.put(AuditActions.USER_PROFILE_UPDATE, "更新用户资料");
        actions.put(AuditActions.USER_ENABLE, "启用用户");
        actions.put(AuditActions.USER_DISABLE, "禁用用户");
        actions.put(AuditActions.USER_PASSWORD_RESET, "重置密码");
        actions.put(AuditActions.USER_ROLES_UPDATE, "更新用户角色");
        actions.put(AuditActions.USER_SELF_PROFILE_UPDATE, "修改个人资料");
        actions.put(AuditActions.USER_PASSWORD_CHANGE, "修改登录密码");
        actions.put(AuditActions.ROLE_CREATE, "创建角色");
        actions.put(AuditActions.ROLE_PERMISSIONS_UPDATE, "更新角色权限");
        actions.put(AuditActions.LANGUAGE_CREATE, "创建语言");
        actions.put(AuditActions.LANGUAGE_UPDATE, "更新语言");
        actions.put(AuditActions.LANGUAGE_ENABLE, "启用语言");
        actions.put(AuditActions.LANGUAGE_DISABLE, "停用语言");
        actions.put(AuditActions.LANGUAGE_DEFAULT, "设置默认语言");
        actions.put(AuditActions.SYSTEM_SETTING_UPDATE, "更新系统设置");
        ACTION_DISPLAY = Collections.unmodifiableMap(actions);

        Map<String, String> targetTypes = new LinkedHashMap<>();
        targetTypes.put("plugin", "插件");
        targetTypes.put("user", "用户");
        targetTypes.put("role", "角色");
        targetTypes.put("language", "语言");
        targetTypes.put("system-setting", "系统设置");
        TARGET_TYPE_DISPLAY = Collections.unmodifiableMap(targetTypes);

        Map<String, String> outcomes = new LinkedHashMap<>();
        outcomes.put("SUCCESS", "成功");
        outcomes.put("FAILURE", "失败");
        OUTCOME_DISPLAY = Collections.unmodifiableMap(outcomes);
    }
